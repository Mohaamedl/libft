...
/**
 * @brief Fills the first len bytes of the memory area pointed to by b with the
 * constant byte c.
 */
...
/**
 * @brief Removes all characters from the beginning and end of s1 that are in
 * set.
 */
...
/**
 * @brief Applies function f to each character of the string, creating a new
 * string with the results.
 */
char	*ft_strmapi(char const *s, char (*f)(unsigned int, char));

/**
 * @brief Applies function f to each character of the string, modifying it
 * in-place.
 */
